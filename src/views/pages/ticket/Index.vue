...
export default {
  ...
  components: {
    TableListOfTickets: () => import('@/components/tables/table-list-of-tickets/TableListOfTickets'),
    Multiselect: () => import('vue-multiselect'),
    ModalTicketInformation: () => import('@/components/modals/ModalTicketInformation'),
