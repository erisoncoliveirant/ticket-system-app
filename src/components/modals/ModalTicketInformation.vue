...
export default {
  ...
  components: {
    TableListAssignedEmployeeTicket: () => import('@/components/tables/table-list-assigned-employee-ticket/TableListAssignedEmployeeTicket'),
    TableListTimeEntryTicket: () => import('@/components/tables/table-list-time-entry-ticket/TableListTimeEntryTicket')
  },
  created () {},
  data () {
    return {
